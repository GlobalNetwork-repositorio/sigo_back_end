package com.adicse.sigo.specification;

import com.adicse.sigo.specification.exception.SpecificationException;
...
import static com.adicse.sigo.specification.Filter.*;
    ...
    private Predicate doGetPredicate(CriteriaBuilder cb, Path<Object> path, String operator, Object value) throws SpecificationException {
        ...
        switch (operator) {
            ...
            case IS_NOT_EMPTY:
                ...
                break;
            case CONTAINS:
                p = cb.like(cb.lower(path.as(String.class)), "%" + String.valueOf(value).toLowerCase() + "%");
                break;
            case NOT_CONTAINS:
            	// convertir a minusculas para comparar
                p =  cb.notLike(cb.lower(path.as(String.class)), "%" + String.valueOf(value).toLowerCase() + "%");
                break;
            case START_WITH:
